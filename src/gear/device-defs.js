...
export const deviceDefs = {
  ...
  korg_minilogue_xd: {
    ...
    // 200 programs, all pre-named from factory. PC 0-139: patches. PC 140-149: PTN. PC 150-199: TPL.
    // Names per @onceihadacat Medium article (confirmed). ccValues empty; send PC to load hardware patch.
    programSelect: { label: 'Program', min: 0, max: 199, def: 0 },
    starterPresets: [
      { name: 'Replicant xd',  recallPC: 0,   ccValues: {} },
      { name: 'TyoCityLoop',   recallPC: 1,   ccValues: {} },
      { name: 'Sharp Fifth',   recallPC: 2,   ccValues: {} },
      { name: 'Quarra',        recallPC: 3,   ccValues: {} },
      { name: 'Terror Key',    recallPC: 4,   ccValues: {} },
      { name: 'PWM Cloud',     recallPC: 5,   ccValues: {} },
      { name: 'Pump SAW',      recallPC: 6,   ccValues: {} },
      { name: 'Orchestra xD',  recallPC: 7,   ccValues: {} },
      { name: 'MirroredBass',  recallPC: 8,   ccValues: {} },
      { name: 'Mr. Squelch',   recallPC: 9,   ccValues: {} },
      { name: 'MetalFnkLead',  recallPC: 10,  ccValues: {} },
      { name: 'Space Clavi',   recallPC: 11,  ccValues: {} },
      { name: 'VelocityStab',  recallPC: 12,  ccValues: {} },
      { name: 'Bassblaster',   recallPC: 13,  ccValues: {} },
      { name: 'Digital Rush',  recallPC: 14,  ccValues: {} },
      { name: 'OnTheLevel',    recallPC: 15,  ccValues: {} },
      { name: 'CheeseRoyale',  recallPC: 16,  ccValues: {} },
      { name: 'BabeWave',      recallPC: 17,  ccValues: {} },
      { name: 'Pluck VPM',     recallPC: 18,  ccValues: {} },
      { name: 'Pulsating80s',  recallPC: 19,  ccValues: {} },
      { name: 'Fifth Kiss',    recallPC: 20,  ccValues: {} },
      { name: 'Warm Dtn',      recallPC: 21,  ccValues: {} },
      { name: 'Funky Stab',    recallPC: 22,  ccValues: {} },
      { name: 'Harp xd',       recallPC: 23,  ccValues: {} },
      { name: 'Future Pulse',  recallPC: 24,  ccValues: {} },
      { name: 'Atk&Rel',       recallPC: 25,  ccValues: {} },
      { name: 'Prolly800mk2',  recallPC: 26,  ccValues: {} },
      { name: 'Kawaii Chord',  recallPC: 27,  ccValues: {} },
      { name: 'Creep Lights',  recallPC: 28,  ccValues: {} },
      { name: 'Trill Synth',   recallPC: 29,  ccValues: {} },
      { name: 'LapisLazuli',   recallPC: 30,  ccValues: {} },
      { name: 'Claymate',      recallPC: 31,  ccValues: {} },
      { name: 'DownStair',     recallPC: 32,  ccValues: {} },
      { name: 'FallingPluck',  recallPC: 33,  ccValues: {} },
      { name: 'Rainchild',     recallPC: 34,  ccValues: {} },
      { name: 'Tape*Sine',     recallPC: 35,  ccValues: {} },
      { name: 'Mini Moon',     recallPC: 36,  ccValues: {} },
      { name: 'Petrichor',     recallPC: 37,  ccValues: {} },
      { name: 'LoFi Strings',  recallPC: 38,  ccValues: {} },
      { name: 'Signal Key',    recallPC: 39,  ccValues: {} },
      { name: 'Organ xd',      recallPC: 40,  ccValues: {} },
      { name: 'Organic Keys',  recallPC: 41,  ccValues: {} },
      { name: 'K.ORG',         recallPC: 42,  ccValues: {} },
      { name: 'Soapy EP',      recallPC: 43,  ccValues: {} },
      { name: 'Logue Lady',    recallPC: 44,  ccValues: {} },
      { name: "90's EPiano",   recallPC: 45,  ccValues: {} },
      { name: 'XD Seven',      recallPC: 46,  ccValues: {} },
      { name: 'Roadz Bell',    recallPC: 47,  ccValues: {} },
      { name: 'Glocken xd',    recallPC: 48,  ccValues: {} },
      { name: 'Smart Bell',    recallPC: 49,  ccValues: {} },
      { name: 'FantaBell',     recallPC: 50,  ccValues: {} },
      { name: 'GateStepps',    recallPC: 51,  ccValues: {} },
      { name: 'Gate 4AM',      recallPC: 52,  ccValues: {} },
      { name: '1982theme',     recallPC: 53,  ccValues: {} },
      { name: 'LukeWarm Pad',  recallPC: 54,  ccValues: {} },
      { name: 'RiseToPower',   recallPC: 55,  ccValues: {} },
      { name: 'Eyes Of Owl',   recallPC: 56,  ccValues: {} },
      { name: 'Nowhere Pad',   recallPC: 57,  ccValues: {} },
      { name: 'WaveSeq Pad',   recallPC: 58,  ccValues: {} },
      { name: 'GlasssinePad',  recallPC: 59,  ccValues: {} },
      { name: 'Angelic Vox',   recallPC: 60,  ccValues: {} },
      { name: 'Plastic Pad',   recallPC: 61,  ccValues: {} },
      { name: 'Haunted Pad',   recallPC: 62,  ccValues: {} },
      { name: 'Gaia Dawn',     recallPC: 63,  ccValues: {} },
      { name: 'Swollen Pad',   recallPC: 64,  ccValues: {} },
      { name: 'Xtra Fat',      recallPC: 65,  ccValues: {} },
      { name: 'Sacred Wall',   recallPC: 66,  ccValues: {} },
      { name: 'Ring PWM',      recallPC: 67,  ccValues: {} },
      { name: 'BrightStrngs',  recallPC: 68,  ccValues: {} },
      { name: 'Square Drone',  recallPC: 69,  ccValues: {} },
      { name: 'Boombastic',    recallPC: 70,  ccValues: {} },
      { name: 'Dirty Trappn',  recallPC: 71,  ccValues: {} },
      { name: 'M.G.Bass',      recallPC: 72,  ccValues: {} },
      { name: 'Octava Bass',   recallPC: 73,  ccValues: {} },
      { name: 'PWM Bass',      recallPC: 74,  ccValues: {} },
      { name: 'Cutie Bass',    recallPC: 75,  ccValues: {} },
      { name: 'Anchor Bass',   recallPC: 76,  ccValues: {} },
      { name: 'TriKO Bass',    recallPC: 77,  ccValues: {} },
      { name: 'Pluck Bass',    recallPC: 78,  ccValues: {} },
      { name: 'Sharp Teeth',   recallPC: 79,  ccValues: {} },
      { name: 'Hypno Acid',    recallPC: 80,  ccValues: {} },
      { name: 'Spike Bass',    recallPC: 81,  ccValues: {} },
      { name: 'Pure Vintage',  recallPC: 82,  ccValues: {} },
      { name: 'Tronic Bass',   recallPC: 83,  ccValues: {} },
      { name: 'Multi Bass',    recallPC: 84,  ccValues: {} },
      { name: 'Thick Bass',    recallPC: 85,  ccValues: {} },
      { name: 'FM Dubz',       recallPC: 86,  ccValues: {} },
      { name: 'Brawl Bass',    recallPC: 87,  ccValues: {} },
      { name: 'Wire Bass',     recallPC: 88,  ccValues: {} },
      { name: 'ScreaFM Bass',  recallPC: 89,  ccValues: {} },
      { name: 'Dirty Pulse',   recallPC: 90,  ccValues: {} },
      { name: 'Crude Pulse',   recallPC: 91,  ccValues: {} },
      { name: 'Flat Lead',     recallPC: 92,  ccValues: {} },
      { name: 'Cheese Lead',   recallPC: 93,  ccValues: {} },
      { name: 'Classic Lead',  recallPC: 94,  ccValues: {} },
      { name: 'Waard Lead',    recallPC: 95,  ccValues: {} },
      { name: 'OrientalLead',  recallPC: 96,  ccValues: {} },
      { name: 'RingSoloLead',  recallPC: 97,  ccValues: {} },
      { name: 'Rave Synth',    recallPC: 98,  ccValues: {} },
      { name: 'Detuned Saw',   recallPC: 99,  ccValues: {} },
      { name: 'Pressure',      recallPC: 100, ccValues: {} },
      { name: 'Vreeeew',       recallPC: 101, ccValues: {} },
      { name: 'EvilSyncLead',  recallPC: 102, ccValues: {} },
      { name: 'OvrdriveLead',  recallPC: 103, ccValues: {} },
      { name: 'Hybrid',        recallPC: 104, ccValues: {} },
      { name: 'Hoover Cloud',  recallPC: 105, ccValues: {} },
      { name: 'Dense Lead',    recallPC: 106, ccValues: {} },
      { name: 'The Blob',      recallPC: 107, ccValues: {} },
      { name: 'WaveringLead',  recallPC: 108, ccValues: {} },
      { name: 'Message From',  recallPC: 109, ccValues: {} },
      { name: 'Joystick!',     recallPC: 110, ccValues: {} },
      { name: '#brew time',    recallPC: 111, ccValues: {} },
      { name: 'Duality',       recallPC: 112, ccValues: {} },
      { name: 'Cluster 5th',   recallPC: 113, ccValues: {} },
      { name: 'Innerstellar',  recallPC: 114, ccValues: {} },
      { name: 'xdBassRepeat',  recallPC: 115, ccValues: {} },
      { name: 'Cloud Level',   recallPC: 116, ccValues: {} },
      { name: 'Beautyvolver',  recallPC: 117, ccValues: {} },
      { name: 'Sparkles',      recallPC: 118, ccValues: {} },
      { name: 'Trance Vibes',  recallPC: 119, ccValues: {} },
      { name: 'Warpeggio',     recallPC: 120, ccValues: {} },
      { name: 'LetGo Arp',     recallPC: 121, ccValues: {} },
      { name: 'Fat Plucks',    recallPC: 122, ccValues: {} },
      { name: 'Alarm&Bottle',  recallPC: 123, ccValues: {} },
      { name: 'Deep Flavor',   recallPC: 124, ccValues: {} },
      { name: 'Piano Chord',   recallPC: 125, ccValues: {} },
      { name: 'Gxyexp Stab',   recallPC: 126, ccValues: {} },
      { name: 'Lush m7',       recallPC: 127, ccValues: {} },
      { name: 'SpiralNebula',  recallPC: 128, ccValues: {} },
      { name: 'Third Code',    recallPC: 129, ccValues: {} },
      { name: 'Sirens',        recallPC: 130, ccValues: {} },
      { name: 'Halo Pad',      recallPC: 131, ccValues: {} },
      { name: 'Antidote',      recallPC: 132, ccValues: {} },
      { name: 'Starship',      recallPC: 133, ccValues: {} },
      { name: 'Space Acid',    recallPC: 134, ccValues: {} },
      { name: 'Late Riser',    recallPC: 135, ccValues: {} },
      { name: 'Doppler Pad',   recallPC: 136, ccValues: {} },
      { name: 'Disco Callin',  recallPC: 137, ccValues: {} },
      { name: 'RuinHitChart',  recallPC: 138, ccValues: {} },
      { name: 'Broken Toy',    recallPC: 139, ccValues: {} },
      { name: 'PTN Techno1',   recallPC: 140, ccValues: {} },
      { name: 'PTN Techno2',   recallPC: 141, ccValues: {} },
      { name: 'PTN DubTch',    recallPC: 142, ccValues: {} },
      { name: 'PTN Acieeed?',  recallPC: 143, ccValues: {} },
      { name: 'PTN Mutant',    recallPC: 144, ccValues: {} },
      { name: 'PTN Mellow',    recallPC: 145, ccValues: {} },
      { name: 'Game On!',      recallPC: 146, ccValues: {} },
      { name: '16bt Bass',     recallPC: 147, ccValues: {} },
      { name: 'VPM Plant',     recallPC: 148, ccValues: {} },
      { name: 'BDSDHHTOM',     recallPC: 149, ccValues: {} },
      { name: 'TPL BasicSaw',  recallPC: 150, ccValues: {} },
      { name: 'TPL BasicTri',  recallPC: 151, ccValues: {} },
      { name: 'TPL BasicSqr',  recallPC: 152, ccValues: {} },
      { name: 'TPL BasicSin',  recallPC: 153, ccValues: {} },
      { name: 'TPL LayerOct',  recallPC: 154, ccValues: {} },
      { name: 'TPL Layer5th',  recallPC: 155, ccValues: {} },
      { name: 'TPL 3sawPoly',  recallPC: 156, ccValues: {} },
      { name: 'TPL 4sawDuo',   recallPC: 157, ccValues: {} },
      { name: 'TPL 8sawMono',  recallPC: 158, ccValues: {} },
      { name: 'TPL SyncVCO2',  recallPC: 159, ccValues: {} },
      { name: 'TPL RingVCO2',  recallPC: 160, ccValues: {} },
      { name: 'TPL XmodVCO2',  recallPC: 161, ccValues: {} },
      { name: 'TPL ResoVelo',  recallPC: 162, ccValues: {} },
      { name: 'TPL ShortTom',  recallPC: 163, ccValues: {} },
      { name: 'TPL Sweeping',  recallPC: 164, ccValues: {} },
      { name: 'TPL EG+1shot',  recallPC: 165, ccValues: {} },
      { name: 'TPL PulseWM',   recallPC: 166, ccValues: {} },
      { name: 'TPL VPMmod',    recallPC: 167, ccValues: {} },
      { name: 'TPL TrillLFO',  recallPC: 168, ccValues: {} },
      { name: 'TPL PumpSaw',   recallPC: 169, ccValues: {} },
      { name: 'TPL ChordHit',  recallPC: 170, ccValues: {} },
      { name: 'TPL RandArp',   recallPC: 171, ccValues: {} },
      { name: 'TPL Repeater',  recallPC: 172, ccValues: {} },
      { name: 'TPL PingPong',  recallPC: 173, ccValues: {} },
      { name: 'TPL Downpour',  recallPC: 174, ccValues: {} },
      { name: 'TPL 100%Wet',   recallPC: 175, ccValues: {} },
      { name: 'TPL Doubling',  recallPC: 176, ccValues: {} },
      { name: 'TPL Parroted',  recallPC: 177, ccValues: {} },
      { name: 'TPL PumpNois',  recallPC: 178, ccValues: {} },
      { name: 'TPL DownSmpl',  recallPC: 179, ccValues: {} },
      { name: 'TPL ThruVCF',   recallPC: 180, ccValues: {} },
      { name: 'TPL 2Sines',    recallPC: 181, ccValues: {} },
      { name: 'TPL Reversed',  recallPC: 182, ccValues: {} },
      { name: 'TPL LongSeq',   recallPC: 183, ccValues: {} },
      { name: 'TPL Strings',   recallPC: 184, ccValues: {} },
      { name: 'TPL Brass',     recallPC: 185, ccValues: {} },
      { name: 'TPL Organ',     recallPC: 186, ccValues: {} },
      { name: 'TPL WahClav',   recallPC: 187, ccValues: {} },
      { name: 'TPL A.EPiano',  recallPC: 188, ccValues: {} },
      { name: 'TPL D.EPiano',  recallPC: 189, ccValues: {} },
      { name: 'TPL A.Bell',    recallPC: 190, ccValues: {} },
      { name: 'TPL D.Bell',    recallPC: 191, ccValues: {} },
      { name: 'TPL SubBass',   recallPC: 192, ccValues: {} },
      { name: 'TPL LofiSine',  recallPC: 193, ccValues: {} },
      { name: 'TPL MonoDriv',  recallPC: 194, ccValues: {} },
      { name: 'TPL RoarVPM',   recallPC: 195, ccValues: {} },
      { name: 'TPL Talkie',    recallPC: 196, ccValues: {} },
      { name: 'TPL Kick',      recallPC: 197, ccValues: {} },
      { name: 'TPL Snare',     recallPC: 198, ccValues: {} },
      { name: 'TPL Hats',      recallPC: 199, ccValues: {} },
    ],
  },
