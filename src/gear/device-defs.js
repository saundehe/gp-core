...
//   starterPresets[] — { name, recallPC, ccValues, bank? } — starter presets copied onto device at add.
//                        recallPC is the 7-bit Program Change byte (0-127, or -1 for none). bank (optional)
//                        is { msb, lsb } Bank Select (CC0/CC32, each 0-127); when present the consumer must
//                        emit Bank Select MSB then LSB before the Program Change. Used by multi-bank synths
//                        (e.g. Korg minilogue xd: 5 banks of 100, PC 0-99 within a bank).
...
export const deviceDefs = {
  ...
  korg_minilogue_xd: {
    ...
    // 200 factory programs (program numbers 1-200; init programs fill 201-500). Program 1-100 => Bank 0,
    // program 101-200 => Bank 1. Naming: 1-140 patches, 141-150 PTN, 151-200 TPL (per @onceihadacat, confirmed).
    // VERIFIED against Korg minilogue xd Owner's Manual (500 memories, 5 banks x 100) + the Korg MIDI
    // Implementation doc: Bank Select MSB (CC0) vv=0, Bank Select LSB (CC32) vv=0-4, Program Change 0-99
    // (True Number 0-99). To recall: send Bank Select MSB=0, LSB=bank, then Program Change. recallPC below is
    // the 0-99 within-bank Program Change byte; bank.lsb selects the bank. ccValues empty; PC loads the patch.
    // programSelect.max is the program-number range (0-199) for the raw Program picker; the send side must
    // derive bank = floor(program/100) and PC = program%100 for programs above 99 (see FABLE report follow-up).
    programSelect: { label: 'Program', min: 0, max: 199, def: 0 },
    starterPresets: [
      { name: 'Replicant xd', recallPC:  0, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'TyoCityLoop',  recallPC:  1, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Sharp Fifth',  recallPC:  2, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Quarra',       recallPC:  3, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Terror Key',   recallPC:  4, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'PWM Cloud',    recallPC:  5, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Pump SAW',     recallPC:  6, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Orchestra xD', recallPC:  7, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'MirroredBass', recallPC:  8, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Mr. Squelch',  recallPC:  9, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'MetalFnkLead', recallPC: 10, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Space Clavi',  recallPC: 11, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'VelocityStab', recallPC: 12, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Bassblaster',  recallPC: 13, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Digital Rush', recallPC: 14, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'OnTheLevel',   recallPC: 15, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'CheeseRoyale', recallPC: 16, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'BabeWave',     recallPC: 17, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Pluck VPM',    recallPC: 18, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Pulsating80s', recallPC: 19, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Fifth Kiss',   recallPC: 20, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Warm Dtn',     recallPC: 21, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Funky Stab',   recallPC: 22, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Harp xd',      recallPC: 23, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Future Pulse', recallPC: 24, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Atk&Rel',      recallPC: 25, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Prolly800mk2', recallPC: 26, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Kawaii Chord', recallPC: 27, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Creep Lights', recallPC: 28, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Trill Synth',  recallPC: 29, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'LapisLazuli',  recallPC: 30, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Claymate',     recallPC: 31, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'DownStair',    recallPC: 32, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'FallingPluck', recallPC: 33, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Rainchild',    recallPC: 34, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Tape*Sine',    recallPC: 35, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Mini Moon',    recallPC: 36, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Petrichor',    recallPC: 37, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'LoFi Strings', recallPC: 38, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Signal Key',   recallPC: 39, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Organ xd',     recallPC: 40, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Organic Keys', recallPC: 41, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'K.ORG',        recallPC: 42, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Soapy EP',     recallPC: 43, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Logue Lady',   recallPC: 44, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: "90's EPiano",  recallPC: 45, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'XD Seven',     recallPC: 46, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Roadz Bell',   recallPC: 47, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Glocken xd',   recallPC: 48, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Smart Bell',   recallPC: 49, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'FantaBell',    recallPC: 50, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'GateStepps',   recallPC: 51, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Gate 4AM',     recallPC: 52, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: '1982theme',    recallPC: 53, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'LukeWarm Pad', recallPC: 54, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'RiseToPower',  recallPC: 55, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Eyes Of Owl',  recallPC: 56, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Nowhere Pad',  recallPC: 57, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'WaveSeq Pad',  recallPC: 58, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'GlasssinePad', recallPC: 59, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Angelic Vox',  recallPC: 60, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Plastic Pad',  recallPC: 61, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Haunted Pad',  recallPC: 62, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Gaia Dawn',    recallPC: 63, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Swollen Pad',  recallPC: 64, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Xtra Fat',     recallPC: 65, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Sacred Wall',  recallPC: 66, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Ring PWM',     recallPC: 67, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'BrightStrngs', recallPC: 68, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Square Drone', recallPC: 69, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Boombastic',   recallPC: 70, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Dirty Trappn', recallPC: 71, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'M.G.Bass',     recallPC: 72, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Octava Bass',  recallPC: 73, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'PWM Bass',     recallPC: 74, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Cutie Bass',   recallPC: 75, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Anchor Bass',  recallPC: 76, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'TriKO Bass',   recallPC: 77, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Pluck Bass',   recallPC: 78, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Sharp Teeth',  recallPC: 79, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Hypno Acid',   recallPC: 80, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Spike Bass',   recallPC: 81, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Pure Vintage', recallPC: 82, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Tronic Bass',  recallPC: 83, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Multi Bass',   recallPC: 84, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Thick Bass',   recallPC: 85, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'FM Dubz',      recallPC: 86, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Brawl Bass',   recallPC: 87, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Wire Bass',    recallPC: 88, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'ScreaFM Bass', recallPC: 89, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Dirty Pulse',  recallPC: 90, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Crude Pulse',  recallPC: 91, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Flat Lead',    recallPC: 92, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Cheese Lead',  recallPC: 93, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Classic Lead', recallPC: 94, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Waard Lead',   recallPC: 95, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'OrientalLead', recallPC: 96, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'RingSoloLead', recallPC: 97, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Rave Synth',   recallPC: 98, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Detuned Saw',  recallPC: 99, bank: { msb: 0, lsb: 0 }, ccValues: {} },
      { name: 'Pressure',     recallPC:  0, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Vreeeew',      recallPC:  1, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'EvilSyncLead', recallPC:  2, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'OvrdriveLead', recallPC:  3, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Hybrid',       recallPC:  4, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Hoover Cloud', recallPC:  5, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Dense Lead',   recallPC:  6, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'The Blob',     recallPC:  7, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'WaveringLead', recallPC:  8, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Message From', recallPC:  9, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Joystick!',    recallPC: 10, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: '#brew time',   recallPC: 11, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Duality',      recallPC: 12, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Cluster 5th',  recallPC: 13, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Innerstellar', recallPC: 14, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'xdBassRepeat', recallPC: 15, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Cloud Level',  recallPC: 16, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Beautyvolver', recallPC: 17, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Sparkles',     recallPC: 18, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Trance Vibes', recallPC: 19, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Warpeggio',    recallPC: 20, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'LetGo Arp',    recallPC: 21, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Fat Plucks',   recallPC: 22, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Alarm&Bottle', recallPC: 23, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Deep Flavor',  recallPC: 24, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Piano Chord',  recallPC: 25, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Gxyexp Stab',  recallPC: 26, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Lush m7',      recallPC: 27, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'SpiralNebula', recallPC: 28, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Third Code',   recallPC: 29, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Sirens',       recallPC: 30, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Halo Pad',     recallPC: 31, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Antidote',     recallPC: 32, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Starship',     recallPC: 33, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Space Acid',   recallPC: 34, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Late Riser',   recallPC: 35, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Doppler Pad',  recallPC: 36, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Disco Callin', recallPC: 37, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'RuinHitChart', recallPC: 38, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Broken Toy',   recallPC: 39, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'PTN Techno1',  recallPC: 40, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'PTN Techno2',  recallPC: 41, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'PTN DubTch',   recallPC: 42, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'PTN Acieeed?', recallPC: 43, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'PTN Mutant',   recallPC: 44, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'PTN Mellow',   recallPC: 45, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'Game On!',     recallPC: 46, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: '16bt Bass',    recallPC: 47, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'VPM Plant',    recallPC: 48, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'BDSDHHTOM',    recallPC: 49, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL BasicSaw', recallPC: 50, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL BasicTri', recallPC: 51, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL BasicSqr', recallPC: 52, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL BasicSin', recallPC: 53, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL LayerOct', recallPC: 54, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Layer5th', recallPC: 55, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL 3sawPoly', recallPC: 56, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL 4sawDuo',  recallPC: 57, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL 8sawMono', recallPC: 58, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL SyncVCO2', recallPC: 59, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL RingVCO2', recallPC: 60, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL XmodVCO2', recallPC: 61, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL ResoVelo', recallPC: 62, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL ShortTom', recallPC: 63, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Sweeping', recallPC: 64, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL EG+1shot', recallPC: 65, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL PulseWM',  recallPC: 66, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL VPMmod',   recallPC: 67, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL TrillLFO', recallPC: 68, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL PumpSaw',  recallPC: 69, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL ChordHit', recallPC: 70, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL RandArp',  recallPC: 71, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Repeater', recallPC: 72, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL PingPong', recallPC: 73, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Downpour', recallPC: 74, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL 100%Wet',  recallPC: 75, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Doubling', recallPC: 76, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Parroted', recallPC: 77, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL PumpNois', recallPC: 78, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL DownSmpl', recallPC: 79, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL ThruVCF',  recallPC: 80, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL 2Sines',   recallPC: 81, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Reversed', recallPC: 82, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL LongSeq',  recallPC: 83, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Strings',  recallPC: 84, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Brass',    recallPC: 85, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Organ',    recallPC: 86, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL WahClav',  recallPC: 87, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL A.EPiano', recallPC: 88, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL D.EPiano', recallPC: 89, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL A.Bell',   recallPC: 90, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL D.Bell',   recallPC: 91, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL SubBass',  recallPC: 92, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL LofiSine', recallPC: 93, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL MonoDriv', recallPC: 94, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL RoarVPM',  recallPC: 95, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Talkie',   recallPC: 96, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Kick',     recallPC: 97, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Snare',    recallPC: 98, bank: { msb: 0, lsb: 1 }, ccValues: {} },
      { name: 'TPL Hats',     recallPC: 99, bank: { msb: 0, lsb: 1 }, ccValues: {} },
        ],
  },
  ...
  korg_microkorg: {
    ...
    // 128 programs: Side A (PC 0-63) + Side B (PC 64-127), 8 genre banks x 8 per side.
    // Side A names per Korg MicroKorg Owner's Manual, Voice Name List (p.77). Side B partial (B.31-B.38 only).
    // Preset names are user-overwritable; factory content restorable via korg.com sound bank download.
    programSelect: { label: 'Program', min: 0, max: 127, def: 0 },
    starterPresets: [
      // Side A — TRANCE (PC 0-7)
      { name: 'Trancey Arpeg.',    recallPC: 0,  ccValues: {} },
      { name: 'Acid Saw Bass',     recallPC: 1,  ccValues: {} },
      { name: 'Unison Saw Lead',   recallPC: 2,  ccValues: {} },
      { name: 'Unison HPF+LPF',   recallPC: 3,  ccValues: {} },
      { name: 'Weepy Lead',        recallPC: 4,  ccValues: {} },
      { name: 'Slippy Pad',        recallPC: 5,  ccValues: {} },
      { name: 'Sweep Poly Pad',    recallPC: 6,  ccValues: {} },
      { name: 'Filter Strings',    recallPC: 7,  ccValues: {} },
      // Side A — TECHNO/HOUSE (PC 8-15)
      { name: 'Auto House',        recallPC: 8,  ccValues: {} },
      { name: "Burnin' Rave",      recallPC: 9,  ccValues: {} },
      { name: 'X-Mod Perc.',       recallPC: 10, ccValues: {} },
      { name: 'House Bass',        recallPC: 11, ccValues: {} },
      { name: 'Distorted Bass',    recallPC: 12, ccValues: {} },
      { name: 'Acid Square Bass',  recallPC: 13, ccValues: {} },
      { name: 'Sync Bass',         recallPC: 14, ccValues: {} },
      { name: 'Hard House Lead',   recallPC: 15, ccValues: {} },
      // Side A — ELECTRONICA (PC 16-23)
      { name: 'PluckSyn',          recallPC: 16, ccValues: {} },
      { name: 'Crispy Lead',       recallPC: 17, ccValues: {} },
      { name: 'Birdy Synth',       recallPC: 18, ccValues: {} },
      { name: 'Peacebells',        recallPC: 19, ccValues: {} },
      { name: 'PanPolyfonic',      recallPC: 20, ccValues: {} },
      { name: 'Trills',            recallPC: 21, ccValues: {} },
      { name: 'Tasty Bath',        recallPC: 22, ccValues: {} },
      { name: 'Oscillation',       recallPC: 23, ccValues: {} },
      // Side A — D'N'B/BREAKS (PC 24-31)
      { name: 'Nasty Bath',        recallPC: 24, ccValues: {} },
      { name: 'ScaryVoxBass',      recallPC: 25, ccValues: {} },
      { name: 'Bad Bass',          recallPC: 26, ccValues: {} },
      { name: "Jaws' Death",       recallPC: 27, ccValues: {} },
      { name: 'Angry Tiger',       recallPC: 28, ccValues: {} },
      { name: 'Lane Drive',        recallPC: 29, ccValues: {} },
      { name: 'Rampaging',         recallPC: 30, ccValues: {} },
      { name: 'RiseFall Arp',      recallPC: 31, ccValues: {} },
      // Side A — HIP-HOP/VINTAGE (PC 32-39)
      { name: 'Disco Bass',        recallPC: 32, ccValues: {} },
      { name: 'eF eM Bass',        recallPC: 33, ccValues: {} },
      { name: 'Whip Lead',         recallPC: 34, ccValues: {} },
      { name: 'Bad Stab',          recallPC: 35, ccValues: {} },
      { name: 'Tine E.Piano',      recallPC: 36, ccValues: {} },
      { name: 'eF eM Piano',       recallPC: 37, ccValues: {} },
      { name: 'VelFiltClav',       recallPC: 38, ccValues: {} },
      { name: 'Robot Mouth',       recallPC: 39, ccValues: {} },
      // Side A — RETRO (PC 40-47)
      { name: 'NewWave Bass',      recallPC: 40, ccValues: {} },
      { name: 'Classic Lead',      recallPC: 41, ccValues: {} },
      { name: 'Spaceship',         recallPC: 42, ccValues: {} },
      { name: 'Major Lead',        recallPC: 43, ccValues: {} },
      { name: 'Squ Rez Lead',      recallPC: 44, ccValues: {} },
      { name: 'Lofi Beep',         recallPC: 45, ccValues: {} },
      { name: 'Cerebellum',        recallPC: 46, ccValues: {} },
      { name: 'SimpleString',      recallPC: 47, ccValues: {} },
      // Side A — S.E./HIT (PC 48-55)
      { name: 'Sickness',          recallPC: 48, ccValues: {} },
      { name: 'Light Gun',         recallPC: 49, ccValues: {} },
      { name: 'Transporter',       recallPC: 50, ccValues: {} },
      { name: 'Antiterror',        recallPC: 51, ccValues: {} },
      { name: 'Sweep Chord',       recallPC: 52, ccValues: {} },
      { name: 'Bruiser',           recallPC: 53, ccValues: {} },
      { name: 'Haus Chord',        recallPC: 54, ccValues: {} },
      { name: 'Love Parade',       recallPC: 55, ccValues: {} },
      // Side A — VOCODER (PC 56-63)
      { name: 'Vox Chord',         recallPC: 56, ccValues: {} },
      { name: 'Singer',            recallPC: 57, ccValues: {} },
      { name: 'LadyVoyce',         recallPC: 58, ccValues: {} },
      { name: 'DemonVoyce',        recallPC: 59, ccValues: {} },
      { name: 'Crystalize',        recallPC: 60, ccValues: {} },
      { name: 'Chopping',          recallPC: 61, ccValues: {} },
      { name: 'Simple Echo',       recallPC: 62, ccValues: {} },
      { name: 'Coil Spring',       recallPC: 63, ccValues: {} },
      // Side B — partial (PC 64-71 TRANCE B, only 64-68 known; 72-79 unknown)
      { name: 'Synth Harp',        recallPC: 64, ccValues: {} },
      { name: 'Acid Ring Bass',    recallPC: 65, ccValues: {} },
      { name: 'Unison Ring Lead',  recallPC: 66, ccValues: {} },
      { name: 'Phaser Lead',       recallPC: 67, ccValues: {} },
      { name: 'Synth Pizz',        recallPC: 68, ccValues: {} },
      // Side B — ELECTRONICA B (PC 80-87, confirmed)
      { name: 'Sequence Pad',      recallPC: 80, ccValues: {} },
      { name: 'Bleeps Perc',       recallPC: 81, ccValues: {} },
      { name: 'Gated Sync Bass',   recallPC: 82, ccValues: {} },
      { name: 'Flap & Sweep',      recallPC: 83, ccValues: {} },
      { name: 'Reverse Lead',      recallPC: 84, ccValues: {} },
      { name: 'IDM Pad',           recallPC: 85, ccValues: {} },
      { name: 'Flanger 5th Pad',   recallPC: 86, ccValues: {} },
      { name: 'Voice /A/',         recallPC: 87, ccValues: {} },
    ],
  },
  ...
  korg_minilogue: {
    ...
    // Programs 001-100 (PC 0-99): factory presets. Names per Korg Minilogue Owner's Manual p.60 (confirmed).
    // Programs 101-200 (PC 100-199): user slots, ship blank. ccValues are empty; send PC to load hardware patch.
    programSelect: { label: 'Program', min: 0, max: 199, def: 0 },
    starterPresets: [
      { name: 'Polylogue',    recallPC: 0,   ccValues: {} },
      { name: 'PWM Strings',  recallPC: 1,   ccValues: {} },
      { name: 'Flutter Pad',  recallPC: 2,   ccValues: {} },
      { name: 'TraxBass',     recallPC: 3,   ccValues: {} },
      { name: 'Ultra Low',    recallPC: 4,   ccValues: {} },
      { name: 'Stardom Lead', recallPC: 5,   ccValues: {} },
      { name: 'Fluctuation',  recallPC: 6,   ccValues: {} },
      { name: 'King Cheetah', recallPC: 7,   ccValues: {} },
      { name: 'PolySeek',     recallPC: 8,   ccValues: {} },
      { name: 'Magic Spells', recallPC: 9,   ccValues: {} },
      { name: 'Stabber',      recallPC: 10,  ccValues: {} },
      { name: 'S.F. Key',     recallPC: 11,  ccValues: {} },
      { name: 'Late Summer',  recallPC: 12,  ccValues: {} },
      { name: 'Scuba Diving', recallPC: 13,  ccValues: {} },
      { name: 'Soft Brass',   recallPC: 14,  ccValues: {} },
      { name: 'Wah Clav',     recallPC: 15,  ccValues: {} },
      { name: 'FilterMotion', recallPC: 16,  ccValues: {} },
      { name: 'Sing(bout u)', recallPC: 17,  ccValues: {} },
      { name: 'PluckMouse',   recallPC: 18,  ccValues: {} },
      { name: 'PopperSynth',  recallPC: 19,  ccValues: {} },
      { name: 'Cosmic Love',  recallPC: 20,  ccValues: {} },
      { name: 'Lounge Pad',   recallPC: 21,  ccValues: {} },
      { name: 'Pulse Pad',    recallPC: 22,  ccValues: {} },
      { name: 'Liquid Pad',   recallPC: 23,  ccValues: {} },
      { name: 'Prospero',     recallPC: 24,  ccValues: {} },
      { name: 'Burn Low',     recallPC: 25,  ccValues: {} },
      { name: 'Polymonk',     recallPC: 26,  ccValues: {} },
      { name: 'Yes or No',    recallPC: 27,  ccValues: {} },
      { name: 'Polymonk',     recallPC: 28,  ccValues: {} },
      { name: 'Morning Gt.',  recallPC: 29,  ccValues: {} },
      { name: 'Ugly Ducking', recallPC: 30,  ccValues: {} },
      { name: 'Unwilling',    recallPC: 31,  ccValues: {} },
      { name: 'Mountain',     recallPC: 32,  ccValues: {} },
      { name: 'Old Elba',     recallPC: 33,  ccValues: {} },
      { name: 'Lipstick',     recallPC: 34,  ccValues: {} },
      { name: 'Rubber Band',  recallPC: 35,  ccValues: {} },
      { name: 'Vintage Tine', recallPC: 36,  ccValues: {} },
      { name: 'Chico Synth',  recallPC: 37,  ccValues: {} },
      { name: 'Dice Synth',   recallPC: 38,  ccValues: {} },
      { name: 'Joyful',       recallPC: 39,  ccValues: {} },
      { name: 'Majenta',      recallPC: 40,  ccValues: {} },
      { name: 'TriBell',      recallPC: 41,  ccValues: {} },
      { name: 'Pluckey',      recallPC: 42,  ccValues: {} },
      { name: 'Old MusicBox', recallPC: 43,  ccValues: {} },
      { name: 'NoiseScope',   recallPC: 44,  ccValues: {} },
      { name: 'FlutesKey',    recallPC: 45,  ccValues: {} },
      { name: 'Universe Luv', recallPC: 46,  ccValues: {} },
      { name: 'Accordion',    recallPC: 47,  ccValues: {} },
      { name: 'Dirt Bass',    recallPC: 48,  ccValues: {} },
      { name: 'QueBass',      recallPC: 49,  ccValues: {} },
      { name: 'Mega PopBass', recallPC: 50,  ccValues: {} },
      { name: 'OctaBass',     recallPC: 51,  ccValues: {} },
      { name: 'BassRide',     recallPC: 52,  ccValues: {} },
      { name: 'Dark Bass',    recallPC: 53,  ccValues: {} },
      { name: 'Detuned Acid', recallPC: 54,  ccValues: {} },
      { name: 'Nasal Bass',   recallPC: 55,  ccValues: {} },
      { name: 'RingBass',     recallPC: 56,  ccValues: {} },
      { name: 'Housey Bass',  recallPC: 57,  ccValues: {} },
      { name: 'Rhino Bass',   recallPC: 58,  ccValues: {} },
      { name: 'Dungeon',      recallPC: 59,  ccValues: {} },
      { name: 'StackBass',    recallPC: 60,  ccValues: {} },
      { name: 'Organ Bass',   recallPC: 61,  ccValues: {} },
      { name: 'Passing Step', recallPC: 62,  ccValues: {} },
      { name: 'Sterlie Bass', recallPC: 63,  ccValues: {} },
      { name: 'Hoovaaa',      recallPC: 64,  ccValues: {} },
      { name: 'Fallen Rock',  recallPC: 65,  ccValues: {} },
      { name: 'Runaway Lead', recallPC: 66,  ccValues: {} },
      { name: 'G-Lead',       recallPC: 67,  ccValues: {} },
      { name: 'Panic Lead',   recallPC: 68,  ccValues: {} },
      { name: 'Unison Lead',  recallPC: 69,  ccValues: {} },
      { name: 'CutLead',      recallPC: 70,  ccValues: {} },
      { name: 'Cyber Lead',   recallPC: 71,  ccValues: {} },
      { name: 'Sweep Lead',   recallPC: 72,  ccValues: {} },
      { name: 'Jimmy Vision', recallPC: 73,  ccValues: {} },
      { name: 'Vibe Lead',    recallPC: 74,  ccValues: {} },
      { name: 'ManzLead',     recallPC: 75,  ccValues: {} },
      { name: 'Da Lead',      recallPC: 76,  ccValues: {} },
      { name: 'Oct Uni Sync', recallPC: 77,  ccValues: {} },
      { name: 'Delay Seq',    recallPC: 78,  ccValues: {} },
      { name: 'Third Eye',    recallPC: 79,  ccValues: {} },
      { name: 'DualSonic',    recallPC: 80,  ccValues: {} },
      { name: 'Deephit',      recallPC: 81,  ccValues: {} },
      { name: 'Halftime Hit', recallPC: 82,  ccValues: {} },
      { name: 'HarmorChord',  recallPC: 83,  ccValues: {} },
      { name: 'SunnyDetroit', recallPC: 84,  ccValues: {} },
      { name: 'Crystal Band', recallPC: 85,  ccValues: {} },
      { name: 'Foggy Morn',   recallPC: 86,  ccValues: {} },
      { name: 'Teleport 1-2', recallPC: 87,  ccValues: {} },
      { name: 'Thoth Arp',    recallPC: 88,  ccValues: {} },
      { name: 'BlinkyLead',   recallPC: 89,  ccValues: {} },
      { name: 'Arp Bass',     recallPC: 90,  ccValues: {} },
      { name: 'Password',     recallPC: 91,  ccValues: {} },
      { name: 'Drip City',    recallPC: 92,  ccValues: {} },
      { name: 'Healer Seq',   recallPC: 93,  ccValues: {} },
      { name: 'Dream Seq',    recallPC: 94,  ccValues: {} },
      { name: 'Spark!',       recallPC: 95,  ccValues: {} },
      { name: 'Mono Growl',   recallPC: 96,  ccValues: {} },
      { name: 'NoisyPopToms', recallPC: 97,  ccValues: {} },
      { name: 'Motion Beat',  recallPC: 98,  ccValues: {} },
      { name: 'Beat Salad',   recallPC: 99,  ccValues: {} },
    ],
  },
  ...
  korg_prologue: {
    ...
    // 500 programs: 001-250 factory, 251-500 user. PC 0-127 = programs 1-128 (Bank 0).
    // Programs 129-250 require Bank Select CC0=1 + PC 0-121 — not mapped here until factory names are retrieved.
    // Factory names not available in text-extractable sources; open prologue_OM_E7.pdf pp.72-81 for the full list.
    programSelect: { label: 'Program', min: 0, max: 127, def: 0 },
    starterPresets: [
  ...
  behringer_deepmind_12: {
    ...
    // 1024 presets: 8 banks (A-H) x 128. Bank A = CC0 (Bank MSB) 0 + PC 0-127. Banks B-H need Bank Select.
    // Bank A names per kamodamusic.com (confirmed). Programmer initials are part of the factory names.
    // ccValues empty; send PC to load hardware patch. Preset names are user-overwritable.
    programSelect: { label: 'Program', min: 0, max: 127, def: 0 },
    starterPresets: [
      { name: 'Blue Dolphin BC',    recallPC: 0,   ccValues: {} },
      { name: 'Chord Play RD',      recallPC: 1,   ccValues: {} },
      { name: 'Heaven Pad KA',      recallPC: 2,   ccValues: {} },
      { name: 'Rich Rises DK',      recallPC: 3,   ccValues: {} },
      { name: 'Hammer Bass KA',     recallPC: 4,   ccValues: {} },
      { name: 'JunoProximityMS',    recallPC: 5,   ccValues: {} },
      { name: 'Sweep & Fold RD',    recallPC: 6,   ccValues: {} },
      { name: 'Robbie2 RBr',        recallPC: 7,   ccValues: {} },
      { name: 'Outer Rim JD',       recallPC: 8,   ccValues: {} },
      { name: 'In My Spot BC',      recallPC: 9,   ccValues: {} },
      { name: 'TensionBass RD',     recallPC: 10,  ccValues: {} },
      { name: 'Bullish DG',         recallPC: 11,  ccValues: {} },
      { name: 'Symphonia KA',       recallPC: 12,  ccValues: {} },
      { name: 'Mono Cloud DK',      recallPC: 13,  ccValues: {} },
      { name: 'Technodisco JD',     recallPC: 14,  ccValues: {} },
      { name: 'AfterGlow RD',       recallPC: 15,  ccValues: {} },
      { name: 'Brassy KA',          recallPC: 16,  ccValues: {} },
      { name: '2Wheel Drive RB',    recallPC: 17,  ccValues: {} },
      { name: 'EventHorizen RD',    recallPC: 18,  ccValues: {} },
      { name: '1973 RD',            recallPC: 19,  ccValues: {} },
      { name: 'MouseChord DK',      recallPC: 20,  ccValues: {} },
      { name: 'Phat Morph KA',      recallPC: 21,  ccValues: {} },
      { name: 'BlissPad RD',        recallPC: 22,  ccValues: {} },
      { name: 'Up In Clouds RD',    recallPC: 23,  ccValues: {} },
      { name: 'Dark Apostle JD',    recallPC: 24,  ccValues: {} },
      { name: "Gianni'Arp SG",      recallPC: 25,  ccValues: {} },
      { name: 'Slasher DK',         recallPC: 26,  ccValues: {} },
      { name: 'Bass Punch DK',      recallPC: 27,  ccValues: {} },
      { name: 'TineEP1 DG',         recallPC: 28,  ccValues: {} },
      { name: 'Massive KA',         recallPC: 29,  ccValues: {} },
      { name: 'BOC Pad RD',         recallPC: 30,  ccValues: {} },
      { name: 'Juppy Synth KA',     recallPC: 31,  ccValues: {} },
      { name: 'Helix Repeat RB',    recallPC: 32,  ccValues: {} },
      { name: 'HammondCrunchDG',    recallPC: 33,  ccValues: {} },
      { name: 'Nightdrive BC',      recallPC: 34,  ccValues: {} },
      { name: 'Brass Pad BC',       recallPC: 35,  ccValues: {} },
      { name: 'Influx Pad KA',      recallPC: 36,  ccValues: {} },
      { name: 'Tundra RD',          recallPC: 37,  ccValues: {} },
      { name: 'CS Strings KA',      recallPC: 38,  ccValues: {} },
      { name: 'Nice Pad KA',        recallPC: 39,  ccValues: {} },
      { name: 'Echo Base JD',       recallPC: 40,  ccValues: {} },
      { name: 'Arptastic2 RB',      recallPC: 41,  ccValues: {} },
      { name: 'Movement ST',        recallPC: 42,  ccValues: {} },
      { name: 'Poly Dream RD',      recallPC: 43,  ccValues: {} },
      { name: "Funkin'FilthyBC",    recallPC: 44,  ccValues: {} },
      { name: 'Battleground BC',    recallPC: 45,  ccValues: {} },
      { name: 'SynthBass 3 KA',     recallPC: 46,  ccValues: {} },
      { name: 'Ethereal Pad RD',    recallPC: 47,  ccValues: {} },
      { name: 'Flutter Seq DK',     recallPC: 48,  ccValues: {} },
      { name: 'In The Air 1 KA',    recallPC: 49,  ccValues: {} },
      { name: 'ModDecimator JD',    recallPC: 50,  ccValues: {} },
      { name: 'Rich Chords RD',     recallPC: 51,  ccValues: {} },
      { name: 'Human Pad KA',       recallPC: 52,  ccValues: {} },
      { name: 'Chord Pulse RD',     recallPC: 53,  ccValues: {} },
      { name: 'Wide StringsST',     recallPC: 54,  ccValues: {} },
      { name: 'ReedEP1 DG',         recallPC: 55,  ccValues: {} },
      { name: 'Abyss JD',           recallPC: 56,  ccValues: {} },
      { name: 'Pwm Pad RB',         recallPC: 57,  ccValues: {} },
      { name: 'Slow Glide RD',      recallPC: 58,  ccValues: {} },
      { name: 'Movement BC',        recallPC: 59,  ccValues: {} },
      { name: 'Punch Bass KA',      recallPC: 60,  ccValues: {} },
      { name: 'DreamSeq RD',        recallPC: 61,  ccValues: {} },
      { name: 'Soft Mono DK',       recallPC: 62,  ccValues: {} },
      { name: 'ElecKoto DG',        recallPC: 63,  ccValues: {} },
      { name: 'Zero Bass JD',       recallPC: 64,  ccValues: {} },
      { name: 'Flead RB',           recallPC: 65,  ccValues: {} },
      { name: 'Planet Zion RD',     recallPC: 66,  ccValues: {} },
      { name: 'Arp+Seq BC',         recallPC: 67,  ccValues: {} },
      { name: 'Rock On KA',         recallPC: 68,  ccValues: {} },
      { name: 'Fairy Tales RD',     recallPC: 69,  ccValues: {} },
      { name: 'Lost Verb DK',       recallPC: 70,  ccValues: {} },
      { name: 'Bilitis 1 KA',       recallPC: 71,  ccValues: {} },
      { name: 'Groovy! ST',         recallPC: 72,  ccValues: {} },
      { name: 'GlassPoly RD',       recallPC: 73,  ccValues: {} },
      { name: 'Top Bass BC',        recallPC: 74,  ccValues: {} },
      { name: 'Funky Lead KA',      recallPC: 75,  ccValues: {} },
      { name: 'Sweet Pulse RD',     recallPC: 76,  ccValues: {} },
      { name: 'Soft Fifth DK',      recallPC: 77,  ccValues: {} },
      { name: 'Spaceman KA',        recallPC: 78,  ccValues: {} },
      { name: 'Chiffy Arp ST',      recallPC: 79,  ccValues: {} },
      { name: 'Alien Shift RD',     recallPC: 80,  ccValues: {} },
      { name: 'Mean Lead BC',       recallPC: 81,  ccValues: {} },
      { name: 'Rhythm Steps KA',    recallPC: 82,  ccValues: {} },
      { name: 'ReedEP3 DG',         recallPC: 83,  ccValues: {} },
      { name: 'PhaseClav DG',       recallPC: 84,  ccValues: {} },
      { name: 'Dream Pad KA',       recallPC: 85,  ccValues: {} },
      { name: 'Coil Soup ST',       recallPC: 86,  ccValues: {} },
      { name: '2PSweepPad DG',      recallPC: 87,  ccValues: {} },
      { name: 'DeepCheez BC',       recallPC: 88,  ccValues: {} },
      { name: 'Cl&OpHats DG',       recallPC: 89,  ccValues: {} },
      { name: 'Warm BD DG',         recallPC: 90,  ccValues: {} },
      { name: 'Sub Monster ST',     recallPC: 91,  ccValues: {} },
      { name: 'Sync Lead RD',       recallPC: 92,  ccValues: {} },
      { name: 'Squarp BC',          recallPC: 93,  ccValues: {} },
      { name: 'Sawyer Lead KA',     recallPC: 94,  ccValues: {} },
      { name: 'Rez BD DG',          recallPC: 95,  ccValues: {} },
      { name: 'Berlin KA',          recallPC: 96,  ccValues: {} },
      { name: 'Latey Bass ST',      recallPC: 97,  ccValues: {} },
      { name: 'Rotary RhodesDG',    recallPC: 98,  ccValues: {} },
      { name: 'HerbieComp DG',      recallPC: 99,  ccValues: {} },
      { name: 'Iridescent BC',      recallPC: 100, ccValues: {} },
      { name: 'Field Space RD',     recallPC: 101, ccValues: {} },
      { name: 'Snr1 DG',            recallPC: 102, ccValues: {} },
      { name: 'Flange Lead KA',     recallPC: 103, ccValues: {} },
      { name: 'Six Oh OnesiDK',     recallPC: 104, ccValues: {} },
      { name: 'MainBrass DG',       recallPC: 105, ccValues: {} },
      { name: 'Magic Key RD',       recallPC: 106, ccValues: {} },
      { name: 'DeEP2 BC',           recallPC: 107, ccValues: {} },
      { name: 'Soft Swells DK',     recallPC: 108, ccValues: {} },
      { name: 'KApro Pad KA',       recallPC: 109, ccValues: {} },
      { name: 'Dream Arp JD',       recallPC: 110, ccValues: {} },
      { name: 'Old School RD',      recallPC: 111, ccValues: {} },
      { name: 'String Pad KA',      recallPC: 112, ccValues: {} },
      { name: 'Polygroove BC',      recallPC: 113, ccValues: {} },
      { name: 'TineEP2 DG',         recallPC: 114, ccValues: {} },
      { name: 'ChordCrunch DK',     recallPC: 115, ccValues: {} },
      { name: 'Miami Bass KA',      recallPC: 116, ccValues: {} },
      { name: 'Jumpy! ST',          recallPC: 117, ccValues: {} },
      { name: 'Juice3DG',           recallPC: 118, ccValues: {} },
      { name: 'Moving Along RD',    recallPC: 119, ccValues: {} },
      { name: 'Woody Bass DG',      recallPC: 120, ccValues: {} },
      { name: 'Morpholog KA',       recallPC: 121, ccValues: {} },
      { name: 'Cyber Pad KA',       recallPC: 122, ccValues: {} },
      { name: 'EtheriArp BC',       recallPC: 123, ccValues: {} },
      { name: 'CloudCastle RD',     recallPC: 124, ccValues: {} },
      { name: 'Sparkle Lead RD',    recallPC: 125, ccValues: {} },
      { name: 'RubberEP DG',        recallPC: 126, ccValues: {} },
    ],
  },
};
